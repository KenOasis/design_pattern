...
// event brokers => this is also act as mediator
class Game {
  constructor() {
  ...
  constructor(game) {
    ...
    game.events.subscribe(function (sender, args) {
      if (args instanceof PlayerScoredEventArgs && args.goalsScoredSoFar < 3) {
        ...
        console.log(`coach says: What a hatrick with ${args.playerName}.`);
      } else {
        console.log(`coach says: No one can stop ${args.playerName} now!`);
      }
    });
  }
}
